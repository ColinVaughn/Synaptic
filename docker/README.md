...
```text
docker build -f docker/synaptic-engine.Dockerfile -t synaptic-engine:0.9.12 .
docker build -f docker/synaptic-engine-worker.Dockerfile -t synaptic-engine-worker:0.9.12 .
```
