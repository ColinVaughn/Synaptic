...
use codegraph_detect::{detect, FileType, Manifest};
...
use codegraph_semantic::{label_communities, llm_tiebreak, run_semantic_pass};
use rayon::prelude::*;
...
pub(crate) fn write_outputs(
    kg: &KnowledgeGraph,
    analysis: &codegraph_graph::AnalysisResult,
    communities: &BTreeMap<u32, Vec<NodeId>>,
