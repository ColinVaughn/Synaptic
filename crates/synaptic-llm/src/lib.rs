//! Synaptic LLM provider layer: the semantic-pass infrastructure.
//!
...
pub use anthropic::{ANTHROPIC_DEFAULT_MODEL, Anthropic};
pub use bedrock::{BEDROCK_DEFAULT_MODEL, Bedrock};
pub use cache::SemanticCache;
pub use claude_cli::ClaudeCli;
pub use cost::{Pricing, estimate_cost, pricing};
pub use error::LlmError;
pub use extract::{Document, Fragment, extract_corpus, extract_with_adaptive_retry};
pub use prompts::EXTRACTION_SYSTEM;
pub use provider::{Completion, LlmClient, OpenAiCompat};
pub use registry::{
    ALL_BACKENDS, BACKENDS, BackendConfig, build_client, default_concurrency, detect_backend,
    detect_backend_env, make_backend, resolve_backend,
};
pub use sigv4::Credentials;
pub use text::{chunk_by_tokens, count_tokens, estimate_tokens, parse_llm_json, wrap_untrusted};
pub use vision::{
    IMAGE_TOKEN_ESTIMATE, ImageRef, MAX_IMAGES_PER_CHUNK, anthropic_content,
    backend_supports_vision, build_image_refs, image_notes, is_vision_image, openai_content,
