...
mod tests {
    ...
    fn graph_from(json: serde_json::Value) -> codegraph_graph::KnowledgeGraph {
        let gd: codegraph_core::GraphData = serde_json::from_value(json).unwrap();
        codegraph_graph::KnowledgeGraph::from_graph_data(gd)
    }
