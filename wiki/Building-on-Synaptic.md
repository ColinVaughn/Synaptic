...
> produces. Reading it imposes no Synaptic licensing obligation on your code.
> Linking the Synaptic crates into a program creates a combined work licensed
> under `AGPL-3.0-or-later`. Historical copies and releases retain the licenses
> under which they were received; this relicensing does not revoke those grants.
